//Damit wir keine Dependency Themen im Workshop haben, habe ich das VS aus dem deutschen Basisprofil kopiert. Bitte nicht nachmachen :)
...
* include codes from system http://fhir.de/CodeSystem/bfarm/ops where parent = "9-984"